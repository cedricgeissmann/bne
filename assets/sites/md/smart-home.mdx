...
<Presentation>
  ...
  <Slide>
    ...
    <Basement className="fragment">
      Zugriff von außerhalb erfolgt über NAT (Network Address Translation).
    </Basement>
  </Slide>
  <Slide>
    <h3>Sicherheit</h3>
...
draußen haben, oder es wird ein Zusatzgerät in Ihrem Heimnetzwerk installiert,
das eine direkte Verbindung nach außen hat. Diese Zusatzgeräte sind oft ein
